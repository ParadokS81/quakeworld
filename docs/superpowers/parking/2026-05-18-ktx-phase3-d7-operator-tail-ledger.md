...
[D]=dispositioned. 14 done / 29 PENDING.
...
- Rows dispositioned: 14 / 43 (r13 downspecs CLEAR shared-handler;
  r14 next_best CLEAR affirm-sound). Docket re-anchored this session to the
