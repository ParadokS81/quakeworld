...
**Status:** arc-brainstormer in progress. Pass 1 COMPLETE 2026-05-15 (provenance + staleness schema; decisions D1-D4 in `docs/superpowers/specs/2026-05-15-ktx-mvdsv-l1-describe-fill-design.md`). Passes 2-5 pending.
