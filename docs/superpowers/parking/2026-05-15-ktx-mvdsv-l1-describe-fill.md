...
**Status:** arc-brainstormer in progress. Passes 1-3 COMPLETE (P1 provenance + staleness schema D1-D4, P2 synthesis method + quality bar + review gate D5-D8 + constraints C1/C2 -- 2026-05-15; P3 mechanical-extract pipeline + drift/conflict policy + Phase-0 probe bundle D9-D12 + cross-cutting C3, amends D4/D6/D7 -- 2026-05-16; all in `docs/superpowers/specs/2026-05-15-ktx-mvdsv-l1-describe-fill-design.md`). Passes 4-5 pending; resume cold via `docs/superpowers/parking/2026-05-16-ktx-mvdsv-l1-describe-fill-pass4-handoff.md`.
