...
d. Confirm the Discord OAuth app's redirect URI matches the running MW URL (from Phase 1). Standard PluggableAuth path is `https://wiki-beta.quake.world/index.php?title=Special:PluggableAuthLogin` (or `Special:PluggableAuth` -- verify).
