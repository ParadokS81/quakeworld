...
|---|---|---|---|---|---|---|
| 1 | needs redraft (D2 amendment 2026-05-13) | substrate | [phase-1-drafter-prompt.md](phase-1-drafter-prompt.md) | [phase-1-mw-core.md](phase-1-mw-core.md) (Apache+PHP version; stale -- see D2 amendment, redraft pending) | nginx + `mediawiki:1.39-fpm` + MariaDB 10.11 on Unraid + Cloudflare Tunnel + `wiki-beta.quake.world` | URL returns HTTP 200; Citizen skin loads; anon edit blocked |
