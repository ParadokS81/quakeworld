...
|---|---|---|---|---|
| 0 | in execution | `phase-0-schema-plumbing.md` | Migration 020 (10 CHECKs / 9 tables) + `Project` union widened + 12 `Record<Project>` sites filled (`versions` rows deferred to Phase 1/2 first load) | DB accepts `qtv`/`qwfwd` rows; `tsc --noEmit` green |
