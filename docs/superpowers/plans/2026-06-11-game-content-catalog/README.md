...
| 2 | in execution | `phase-2-monsters.md` | id1 monster stat rows (~15) + wiki snapshot cross-check | `search_gameplay_entities kind=monster gameplay_source=id1` returns the roster |
