...
|---|---|---|---|---|
| 0 | not drafted | `phase-0-prereqs-loader.md` | v1.06 QC tree + provenance; loader `monsters` section; expected_counts STOP-gate rework (F2); citation-gate + seed-double-load probes | Loader accepts all five seed sections; unchanged id1 YAML loads green under the new gate; probes runnable |
