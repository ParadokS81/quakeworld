...
| F23 VitePress Ctrl+K prose-only search is a dead box beside the F18 entity search | SUBSTANTIVE (launch UX) | F14 fix -- disable in config.ts (operator chose A) | D9, D11 |
