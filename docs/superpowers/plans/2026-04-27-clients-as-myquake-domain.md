...
14. **Git workflow** (CLAUDE.md Section  Git workflow): commit to main directly. Single commit covering the IA restructure is fine -- it's a coherent unit. Push at the end. No PR ceremony.
...
- **Reference:** `apps/slipgate-app/docs/OVERVIEW.md` Section  The 6 tabs (current IA before 3.5a ships)
