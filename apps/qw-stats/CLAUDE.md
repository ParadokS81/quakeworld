...
Monorepo-aligned quartet:
- **README.md** - public-facing elevator pitch + Claude Code onboarding (getting started)
- **VISION.md** - why this project exists, the sniff-test problem, the identity-resolution blocker, non-goals
