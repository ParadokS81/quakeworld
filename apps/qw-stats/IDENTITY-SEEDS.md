...
- `name1` (games) — context
- `name2` (games) — context
Co-occurrence: ✅ All verified (no shared games)
...
Co-occurrence: ✅ (implicit — same person filing this document)
...
Co-occurrence: ✅ Implicit (tag format change, same clan)
Source: community (ParadokS)
...
Co-occurrence: ✅ Temporal succession within same clan
Source: community (ParadokS)
Total: ~461 games
...
Co-occurrence: ✅ Implicit (same clan, temporal succession)
Source: community (ParadokS)
Total: ~307 games
...
Co-occurrence: ✅ All verified (no shared games between xunito and overflow variants)
Source: community (ParadokS)
Total: ~1,129 games
...
Co-occurrence: ✅ Never in same game
Source: community (ParadokS)
Total: ~685 games
...
Co-occurrence: ✅ All anni variants verified
Source: community (ParadokS)
Total: ~359 games
...
Co-occurrence: ✅ nas ↔ nastic verified
Source: community (ParadokS)
Total: ~786 games
...
From HX:
- `zamsha` confirmed as shazam alias — ✅
- `szm` confirmed as shazam alias — ✅
