...
Cross-engine coverage is manual grep today. Full Layer 1 entity coverage TBD pending Phase 2d (FTE) Layer 1 extraction. See HANDOVER.md Section  Phase 2d-2h.
