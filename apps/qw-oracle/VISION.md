...
- **Layer 2** - Postgres (`qw_oracle`). 741,128 Quake.World Discord messages (2016-04 -> 2026-08); raw messages plus 40,219 topic-coherent reconstructed threads, each `tsvector`-indexed and embedded (voyage-4-large). The thread is the retrieval unit. Discord-only -- the QuakeNet IRC corpus (2005-2016) was excluded from Arc 1 (`decisions.md` D9-revised; may be revisited in Arc 3). This is the tribal-knowledge tier: debugging sessions, config discussions, gameplay debates, community history.
