...
async function main(): Promise<void> {
  ...
  const input  = values.input  ?? resolve(REPO_ROOT, "apps/qw-oracle/scripts/extractors/ezquake/output/ezquake-asset-loader-sites-ast.json");
  const output = values.output ?? resolve(REPO_ROOT, "apps/qw-oracle/scripts/extractors/ezquake/output/ezquake-reserved-subdirs.json");
