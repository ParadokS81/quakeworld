...
OUTPUT_JSON = Path(_args.output).resolve() if _args.output else (HERE.parent / "output/ezquake-asset-cvar-bindings-ast.json")
DIAGNOSTICS_LOG = HERE.parent / "diagnostics/ast-asset-cvar-bindings-diagnostics.log"
...
def _load_cvar_ident_map() -> None:
    candidate = HERE.parent / "output/ezquake-variables-ast.json"
