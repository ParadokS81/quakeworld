...
OUTPUT_JSON = Path(_args.output).resolve() if _args.output else (HERE.parent / "output/ezquake-asset-loader-sites-ast.json")
DIAGNOSTICS_LOG = HERE.parent / "diagnostics/ast-asset-loader-sites-diagnostics.log"
