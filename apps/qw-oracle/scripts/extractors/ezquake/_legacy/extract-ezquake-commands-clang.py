...
OUTPUT_JSON = Path(_args.output).resolve() if _args.output else (HERE.parent / "output/ezquake-commands-ast.json")
DIAGNOSTICS_LOG = HERE.parent / "diagnostics/ast-commands-diagnostics.log"
