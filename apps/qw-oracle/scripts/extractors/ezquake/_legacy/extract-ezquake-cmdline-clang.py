...
OUTPUT_JSON = Path(_args.output).resolve() if _args.output else (HERE.parent / "output/ezquake-cmdline-params-ast.json")
DIAGNOSTICS_LOG = HERE.parent / "diagnostics/ast-cmdline-diagnostics.log"
