...
OUTPUT_JSON = Path(_args.output).resolve() if _args.output else (HERE.parent / "output/ezquake-variables-ast.json")
DIAGNOSTICS_LOG = HERE.parent / "diagnostics/ast-spike-diagnostics.log"
