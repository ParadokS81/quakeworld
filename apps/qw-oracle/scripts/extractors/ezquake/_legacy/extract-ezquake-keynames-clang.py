...
OUTPUT_JSON = Path(_args.output).resolve() if _args.output else (HERE.parent / "output/ezquake-keynames-ast.json")
DIAGNOSTICS_LOG = HERE.parent / "diagnostics/ast-keynames-diagnostics.log"
