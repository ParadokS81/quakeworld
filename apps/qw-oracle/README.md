...
- **Layer 3** -- hand-authored concept notes at `curated/concept-notes/`. Nine notes shipped, plus README (entry template + 6 shapes + voice table), OPERATIONS (stewardship playbook), and _gap-report (contributor onboarding seed for upstream ezquake.com guide updates).
