/** Simplified mouse SVG for the keyboard diagram decoration.
 *  Rendered as a nested <svg> inside the parent keyboard SVG. */
...
interface MouseDiagramProps {
  ...
  width: number;
  height: number;
  highlights?: Map<string, { color: string }>;
}

export default function MouseDiagram(props: MouseDiagramProps) {
  const hl = (id: string) => props.highlights?.get(id)?.color;

  const wheelColor = () => hl("MWheelUp") || hl("Mouse3") || hl("MWheelDown");
  ...
  const cls = (color: string | undefined) =>
    color ? "sg-mouse-fill sg-mouse-hl" : "sg-mouse-fill";
  ...
  return (
    <svg
      ...
      width={props.width}
      height={props.height}
      viewBox="350 180 920 1700"
      preserveAspectRatio="xMidYMid meet"
      class="sg-kb-mouse-diagram"
    >
      {/* Main body */}
      ...
      {/* Right button (Mouse2) */}
      <path transform="translate(812,233)" d="m0 0h12l28 2 30 4 31 6 30 8 36 12 16 6 23 10 29 14 18 11 12 8 16 12 11 9 10 9 16 16 11 14 8 11 2 15 4 46 2 38 1 33v102l-2 63-3 61-5 80-5 72-4 17-6 12-7 9-5 6-10 8-14 8-28 13-28 11-31 11-27 8-33 8-38 7-30 4-33 3-22 1h-15v-288l18-3 16-6 13-8 10-9 7-7 9-14 5-11 4-14 1-6 1-63v-95l-1-49-4-17-6-14-8-12-9-10-9-8-14-8-12-5-13-3-8-1z" class={cls(hl("Mouse2"))} style={fill(hl("Mouse2"))} />
      {/* Left button (Mouse1) */}
      <path transform="translate(788,233)" d="m0 0h13v137l-18 3-14 5-16 9-13 12-9 12-8 16-4 14-2 16v187l2 18 5 16 7 14 8 10 6 7 13 10 16 8 13 4 14 2 1 287-1 1h-14l-35-2-37-4-26-4-35-7-24-6-33-10-28-10-29-12-28-13-10-6-11-9-8-9-8-14-4-14-1-5-8-119-3-52-3-72-1-46v-82l1-40 3-53 4-41 2-7 10-14 11-13 7-8 8-7 12-11 17-13 15-10 20-12 21-11 25-11 26-10 34-11 30-8 31-6 20-3z" class={cls(hl("Mouse1"))} style={fill(hl("Mouse1"))} />
      {/* Scroll wheel housing */}
      <path transform="translate(802,379)" d="m0 0 18 1 14 4 16 8 10 8 9 9 7 11 5 10 4 14 1 6v204l-4 16-8 16-8 11-9 9-14 9-12 5-12 3h-26l-15-4-17-9-12-11-8-9-8-14-5-16-1-6v-205l4-17 8-16 8-10 10-10 11-7 16-7 9-2z" class={cls(wheelColor())} style={fill(wheelColor())} />
      <path transform="translate(802,379)" d="m0 0 18 1 14 4 16 8 10 8 9 9 7 11 5 10 4 14 1 6v204l-4 16-8 16-8 11-9 9-14 9-12 5-12 3h-26l-15-4-17-9-12-11-8-9-8-14-5-16-1-6v-205l4-17 8-16 8-10 10-10 11-7 16-7 9-2zm-1 38-15 2-17 6-10 7-5 6-4 10v83h-11l-3 3v53l3 3 11 1v68l3 9 6 8 11 7 14 5 11 2h22l14-3 13-5 11-8 6-10 1-4v-69h11l4-3v-53l-2-3-6-1-7 1v-83l-4-11-5-6-11-7-13-5-9-2-9-1z" class={cls(wheelColor())} style={fill(wheelColor())} />
      {/* Side button upper (Mouse5) */}
      <path transform="translate(424,977)" d="m0 0 5 1 10 124 6 74v3l-4-2-7-8-9-15-5-15-4-35-5-51-4-43v-19l4-8 6-4z" class={cls(hl("Mouse5"))} style={fill(hl("Mouse5"))} />
      {/* Side button lower (Mouse4) */}
      <path transform="translate(411,743)" d="m0 0 2 2 7 108 6 88h-11l-7-3-4-5-3-10v-123l1-27 2-14 4-11z" class={cls(hl("Mouse4"))} style={fill(hl("Mouse4"))} />
      {/* Button seam lines */}
