...
See `docs/OVERVIEW.md` for the complete feature map with file landmarks and per-tab detail. See `docs/VISION.md` for what's on the drawing board and why.
...
- `docs/VISION.md` - why this app exists and where it is going
