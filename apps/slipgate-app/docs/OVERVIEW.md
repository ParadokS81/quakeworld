...
> The older `ROADMAP.md`, `FEATURES.md`, and the "Project Structure" section of `CLAUDE.md` describe a much earlier version (3 tabs, system-specs MVP). That ship sailed.
