...
const TemplatesModal = (function() {
    ...
    function _render() {
        ...
        if (template) {
            ...
            body.innerHTML = `
                <div class="space-y-3">
                    ...
                    <div class="border-t border-border pt-3 flex items-center justify-between">
                        <span class="text-sm">Auto-fill weekly (current + next week)</span>
                        <button id="templates-recurring-btn"
                                ...
                                title="Auto-fill your template every week">
            ...
            body.innerHTML = `
                <div class="space-y-3">
                    <p class="text-sm text-muted-foreground">Save a template to enable weekly auto-fill</p>
