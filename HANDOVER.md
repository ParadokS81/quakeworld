...
- **KTX Layer 1 Onboarding** -- planning-drafting; Phase 4 approved (F7/F8 reproduced; F8 explanation amended -- 30/28/2 -> 29/27/2 per live source; 27-row anchor stands; related_weapon canonical names corrected to underscored id1-baseline form for FK-join correctness); next is `phase-5-drafter-prompt.md`. Plan: `docs/superpowers/plans/2026-05-04-ktx-onboarding/README.md` (9 phases total).
