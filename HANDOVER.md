...
### Ongoing arcs
- [Arc workflow skill set — wave 1 build](docs/superpowers/parking/2026-05-03-arc-skill-set-wave1-handoff.md) — design conversation closed 2026-05-03; findings doc at `docs/superpowers/parking/2026-05-03-arc-skill-set-findings.md`. Wave 1 = arc-classifier + arc-brainstormer + arc-planner + arc-phase-archetypes.md reference doc; queued for fresh-terminal execution. Slipgate Managed Mode planning consumes wave 1 before wave 2 (arc-orchestrator + arc-executor + arc-reviewer) gets built.
