...
- **KTX Layer 1 Onboarding** -- planning-drafting; Phase 0 approved (F22 added during drafting); next is `phase-1-drafter-prompt.md`. Plan: `docs/superpowers/plans/2026-05-04-ktx-onboarding/README.md` (9 phases total).
