...
### Ongoing arcs
- [qw-oracle Arc 1 — Postgres + hybrid retrieval](docs/superpowers/plans/2026-05-02-qw-oracle-arc1/README.md) — 8-phase per-phase MD plan. Phases 1-4 shipped (Phase 4 lands Layer 3 storage + bidirectional graph + chunker; 9 concepts / 115 chunks / 82 entity edges in `qw_oracle`; embeddings still NULL until Phase 5). Phases 5-8 drafted and approved. Resume execution at Phase 5 (Voyage embedding pipeline -- entity + chunk workers, embedding-space verification per D8).
