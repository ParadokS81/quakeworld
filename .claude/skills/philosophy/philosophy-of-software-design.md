> Adapted from vikpe's slipgate web repo at `research/repos/slipgate/llm/skills/`, copied 2026-04-11 (em dashes and en dashes normalized to ASCII hyphen-minus at copy time). Update from upstream rather than editing in place when the source changes.
